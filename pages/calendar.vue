...
export default {
  ...
  mounted() {
    ...
    this.load(this.$date().format('YYYY/MM'))
  },
  methods: {
    ...mapActions({
    ...
    load(date) {
      console.log(date)
      this.getTasks({
        fromdate: this.$date(date, 'YYYY/MM').format('YYYY-MM-DD'),
        todate: this.$date(date, 'YYYY/MM')
          .endOf('month')
          .add(1, 'day')
          .format('YYYY-MM-DD'),
        // order[deadline]': 'asc',
      ...
      // this.getTasks({
      //   'deadline[after]': this.$date(date, 'MM/YYYY').format('DD-MM-YYYY'),
      //   'deadline[before]': this.$date(date, 'MM/YYYY')
      //     .endOf('month')
      //     .add(1, 'day')
      //     .format('DD-MM-YYYY'),
      //   'order[deadline]': 'asc',
    ...
    updateRange({ start, end }) {
      this.load(this.$date(start.date).format('YYYY/MM'))
      this.start = start
      this.end = end
    },
  },

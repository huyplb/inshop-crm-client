...
export default {
  ...
  computed: {
    ...
    options() {
      if (
        this.$store.getters[this.optionStore + '/items'].lastItem === undefined
      ) {
        if (this.$props.item[this.optionStore] !== undefined) {
          console.log(this.$props.item[this.optionStore])
          const cars = []
          cars.push(this.$props.item[this.optionStore])
          return cars
        } else return []
      }
      // console.log(this.$store.getters[this.optionStore + '/items'].lastItem)
